const APP_VERSION = '8.8.7.4';
const CACHE_NAME = 'villacart-pos-v' + APP_VERSION;
const OFFLINE_ENTRY = './index.html?v=' + APP_VERSION;
const APP_SHELL = [
  OFFLINE_ENTRY,
  './manifest.webmanifest?v=8.8.7.4',
  './styles.css?v=8.8.7.4',
  './vendor/tailwind-forms-container.js?v=8.8.7.4',
  './vendor/fonts/fonts.css?v=8.8.7.4',
  './vendor/fonts/inter-latin.woff2',
  './vendor/fonts/material-symbols-outlined.woff2',
  './vendor/quagga.min.js?v=8.8.7.4',
  './vendor/firebase-app-compat.js?v=8.8.7.4',
  './vendor/firebase-auth-compat.js?v=8.8.7.4',
  './vendor/firebase-firestore-compat.js?v=8.8.7.4',
  './utils.js?v=8.8.7.4',
  './ledger.js?v=8.8.7.4',
  './receipts.js?v=8.8.7.4',
  
    './receipt-ui.js?v=8.8.7.4',
    './scanner.js?v=8.8.7.4',
    './camera-scanner.js?v=8.8.7.4',
  
    
    './cart.js?v=8.8.7.4',
    './payment-ui.js?v=8.8.7.4',
    './favorites.js?v=8.8.7.4',
    
    './notifications.js?v=8.8.7.4',
    
    './stock-ui.js?v=8.8.7.4',
    './gcash.js?v=8.8.7.4',
  
    './expenses.js?v=8.8.7.4',
    './status-ui.js?v=8.8.7.4',
    './pwa-lifecycle.js?v=8.8.7.4',
    './insights-base.js?v=8.8.7.4',
    './reporting-ui.js?v=8.8.7.4',
    './storage-db.js?v=8.8.7.4',
    './sync-engine.js?v=8.8.7.4',
    './app.js?v=8.8.7.4',
    './item-sales.js?v=8.8.7.4',
    './ledger-ui.js?v=8.8.7.4',
    './backup-actions.js?v=8.8.7.4',
    './business-actions.js?v=8.8.7.4',
  
    './business-ui.js?v=8.8.7.4',
    
    './ui-core.js?v=8.8.7.4',
    './product.js?v=8.8.7.4',
    './settings.js?v=8.8.7.4',
    './inventory-actions.js?v=8.8.7.4',
    './sales-export.js?v=8.8.7.4',
    './transaction-detail.js?v=8.8.7.4',
    './diagnostics.js?v=8.8.7.4',
