const CACHE_NAME = 'villacart-pos-v8.3.19';
...
const APP_SHELL = [
  './',
  './index.html',
  './manifest.webmanifest?v=8.3.19',
  './styles.css?v=8.3.19',
  './utils.js?v=8.3.19',
  './ledger.js?v=8.3.19',
  './receipts.js?v=8.3.19',
  
    './receipt-ui.js?v=8.3.19',
    './scanner.js?v=8.3.19',
    './camera-scanner.js?v=8.3.19',
  
    
    './cart.js?v=8.3.19',
    './payment-ui.js?v=8.3.19',
    './favorites.js?v=8.3.19',
    
    './notifications.js?v=8.3.19',
    
    './stock-ui.js?v=8.3.19',
    './gcash.js?v=8.3.19',
  
    './expenses.js?v=8.3.19',
    './status-ui.js?v=8.3.19',
    './pwa-lifecycle.js?v=8.3.19',
    './insights-base.js?v=8.3.19',
    './reporting-ui.js?v=8.3.19',
    './sync-engine.js?v=8.3.19',
    './app.js?v=8.3.19',
    './ledger-ui.js?v=8.3.19',
    './backup-actions.js?v=8.3.19',
    './business-actions.js?v=8.3.19',
  
    './business-ui.js?v=8.3.19',
    
    './ui-core.js?v=8.3.19',
    './product.js?v=8.3.19',
    './settings.js?v=8.3.19',
    './inventory-actions.js?v=8.3.19',
    './sales-export.js?v=8.3.19',
    './transaction-detail.js?v=8.3.19',
    './diagnostics.js?v=8.3.19',
