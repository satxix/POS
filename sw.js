const CACHE_NAME = 'villacart-pos-v8.3.11';
...
const APP_SHELL = [
  './',
  './index.html',
  './manifest.webmanifest?v=8.3.11',
  './styles.css?v=8.3.11',
  './utils.js?v=8.3.11',
  './ledger.js?v=8.3.11',
  './receipts.js?v=8.3.11',
  
    './receipt-ui.js?v=8.3.11',
    './scanner.js?v=8.3.11',
    './camera-scanner.js?v=8.3.11',
  
    
    './cart.js?v=8.3.11',
    './payment-ui.js?v=8.3.11',
    './favorites.js?v=8.3.11',
    
    './notifications.js?v=8.3.11',
    
    './stock-ui.js?v=8.3.11',
    './gcash.js?v=8.3.11',
  
    './expenses.js?v=8.3.11',
    './status-ui.js?v=8.3.11',
    './pwa-lifecycle.js?v=8.3.11',
    './insights-base.js?v=8.3.11',
    './reporting-ui.js?v=8.3.11',
    './app.js?v=8.3.11',
    './backup-actions.js?v=8.3.11',
    './business-actions.js?v=8.3.11',
  
    './business-ui.js?v=8.3.11',
    
    './ui-core.js?v=8.3.11',
    './product.js?v=8.3.11',
    './settings.js?v=8.3.11',
    './inventory-actions.js?v=8.3.11',
    './sales-export.js?v=8.3.11',
    './transaction-detail.js?v=8.3.11',
    './diagnostics.js?v=8.3.11',
