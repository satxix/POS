...
const APP_SHELL = [
  ...
  './vendor/quagga.min.js?v=8.8.8',
  './vendor/firebase-app-compat.js?v=8.8.8',
  './vendor/firebase-auth-compat.js?v=8.8.8',
  './vendor/firebase-firestore-compat.js?v=8.8.8',
  './utils.js?v=8.8.8',
  './ledger.js?v=8.8.8',
  './receipts.js?v=8.8.8',
  
    './receipt-ui.js?v=8.8.8',
    './scanner.js?v=8.8.8',
    './camera-scanner.js?v=8.8.8',
  
    
    './cart.js?v=8.8.8',
    './payment-ui.js?v=8.8.8',
    './favorites.js?v=8.8.8',
    
    './notifications.js?v=8.8.8',
    
    './stock-ui.js?v=8.8.8',
    './gcash.js?v=8.8.8',
  
    './expenses.js?v=8.8.8',
    './status-ui.js?v=8.8.8',
    './pwa-lifecycle.js?v=8.8.8',
    './insights-base.js?v=8.8.8',
    './reporting-ui.js?v=8.8.8',
    './storage-db.js?v=8.8.8',
