...
const APP_SHELL = [
  OFFLINE_ENTRY,
  './manifest.webmanifest?v=8.5.7',
  './styles.css?v=8.5.7',
  './vendor/tailwind-forms-container.js?v=8.5.7',
  './vendor/fonts/fonts.css?v=8.5.7',
  './vendor/fonts/inter-latin.woff2',
  './vendor/fonts/material-symbols-outlined.woff2',
  './vendor/quagga.min.js?v=8.5.7',
  './vendor/firebase-app-compat.js?v=8.5.7',
  './vendor/firebase-auth-compat.js?v=8.5.7',
  './vendor/firebase-firestore-compat.js?v=8.5.7',
  './utils.js?v=8.5.7',
  './ledger.js?v=8.5.7',
  './receipts.js?v=8.5.7',
  
    './receipt-ui.js?v=8.5.7',
    './scanner.js?v=8.5.7',
    './camera-scanner.js?v=8.5.7',
  
    
    './cart.js?v=8.5.7',
    './payment-ui.js?v=8.5.7',
    './favorites.js?v=8.5.7',
    
    './notifications.js?v=8.5.7',
    
    './stock-ui.js?v=8.5.7',
    './gcash.js?v=8.5.7',
  
    './expenses.js?v=8.5.7',
    './status-ui.js?v=8.5.7',
    './pwa-lifecycle.js?v=8.5.7',
    './insights-base.js?v=8.5.7',
    './reporting-ui.js?v=8.5.7',
    './sync-engine.js?v=8.5.7',
    './app.js?v=8.5.7',
    './item-sales.js?v=8.5.7',
    './ledger-ui.js?v=8.5.7',
    './backup-actions.js?v=8.5.7',
    './business-actions.js?v=8.5.7',
  
    './business-ui.js?v=8.5.7',
    
    './ui-core.js?v=8.5.7',
    './product.js?v=8.5.7',
    './settings.js?v=8.5.7',
    './inventory-actions.js?v=8.5.7',
    './sales-export.js?v=8.5.7',
    './transaction-detail.js?v=8.5.7',
    './diagnostics.js?v=8.5.7',
