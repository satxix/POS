...
const APP_SHELL = [
  OFFLINE_ENTRY,
  './manifest.webmanifest?v=8.6.2',
  './styles.css?v=8.6.2',
  './vendor/tailwind-forms-container.js?v=8.6.2',
  './vendor/fonts/fonts.css?v=8.6.2',
  './vendor/fonts/inter-latin.woff2',
  './vendor/fonts/material-symbols-outlined.woff2',
  './vendor/quagga.min.js?v=8.6.2',
  './vendor/firebase-app-compat.js?v=8.6.2',
  './vendor/firebase-auth-compat.js?v=8.6.2',
  './vendor/firebase-firestore-compat.js?v=8.6.2',
  './utils.js?v=8.6.2',
  './ledger.js?v=8.6.2',
  './receipts.js?v=8.6.2',
  
    './receipt-ui.js?v=8.6.2',
    './scanner.js?v=8.6.2',
    './camera-scanner.js?v=8.6.2',
  
    
    './cart.js?v=8.6.2',
    './payment-ui.js?v=8.6.2',
    './favorites.js?v=8.6.2',
    
    './notifications.js?v=8.6.2',
    
    './stock-ui.js?v=8.6.2',
    './gcash.js?v=8.6.2',
  
    './expenses.js?v=8.6.2',
    './status-ui.js?v=8.6.2',
    './pwa-lifecycle.js?v=8.6.2',
    './insights-base.js?v=8.6.2',
    './reporting-ui.js?v=8.6.2',
    './storage-db.js?v=8.6.2',
    './sync-engine.js?v=8.6.2',
    './app.js?v=8.6.2',
    './item-sales.js?v=8.6.2',
    './ledger-ui.js?v=8.6.2',
    './backup-actions.js?v=8.6.2',
    './business-actions.js?v=8.6.2',
  
    './business-ui.js?v=8.6.2',
    
    './ui-core.js?v=8.6.2',
    './product.js?v=8.6.2',
    './settings.js?v=8.6.2',
    './inventory-actions.js?v=8.6.2',
    './sales-export.js?v=8.6.2',
    './transaction-detail.js?v=8.6.2',
    './diagnostics.js?v=8.6.2',
