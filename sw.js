const CACHE_NAME = 'villacart-pos-v8.3.20';
...
const APP_SHELL = [
  './',
  './index.html',
  './manifest.webmanifest?v=8.3.20',
  './styles.css?v=8.3.20',
  './utils.js?v=8.3.20',
  './ledger.js?v=8.3.20',
  './receipts.js?v=8.3.20',
  
    './receipt-ui.js?v=8.3.20',
    './scanner.js?v=8.3.20',
    './camera-scanner.js?v=8.3.20',
  
    
    './cart.js?v=8.3.20',
    './payment-ui.js?v=8.3.20',
    './favorites.js?v=8.3.20',
    
    './notifications.js?v=8.3.20',
    
    './stock-ui.js?v=8.3.20',
    './gcash.js?v=8.3.20',
  
    './expenses.js?v=8.3.20',
    './status-ui.js?v=8.3.20',
    './pwa-lifecycle.js?v=8.3.20',
    './insights-base.js?v=8.3.20',
    './reporting-ui.js?v=8.3.20',
    './sync-engine.js?v=8.3.20',
    './app.js?v=8.3.20',
    './ledger-ui.js?v=8.3.20',
    './backup-actions.js?v=8.3.20',
    './business-actions.js?v=8.3.20',
  
    './business-ui.js?v=8.3.20',
    
    './ui-core.js?v=8.3.20',
    './product.js?v=8.3.20',
    './settings.js?v=8.3.20',
    './inventory-actions.js?v=8.3.20',
    './sales-export.js?v=8.3.20',
    './transaction-detail.js?v=8.3.20',
    './diagnostics.js?v=8.3.20',
