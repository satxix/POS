const APP_VERSION = '8.8.10';
const CACHE_NAME = 'villacart-pos-v' + APP_VERSION;
const OFFLINE_ENTRY = './index.html?v=' + APP_VERSION;
const APP_SHELL = [
  OFFLINE_ENTRY,
  './manifest.webmanifest?v=8.8.10',
  './styles.css?v=8.8.10-credit-collapse',
  './vendor/tailwind-forms-container.js?v=8.8.10',
  './vendor/fonts/fonts.css?v=8.8.10',
  './vendor/fonts/inter-latin.woff2',
  './vendor/fonts/material-symbols-outlined.woff2',
  './vendor/quagga.min.js?v=8.8.10',
  './vendor/firebase-app-compat.js?v=8.8.10',
  './vendor/firebase-auth-compat.js?v=8.8.10',
  './vendor/firebase-firestore-compat.js?v=8.8.10',
  './utils.js?v=8.8.10',
  './ledger.js?v=8.8.10',
  './receipts.js?v=8.8.10',
  
    './receipt-ui.js?v=8.8.10',
    './scanner.js?v=8.8.10-stock-search',
    './camera-scanner.js?v=8.8.10',
  
    
    './cart.js?v=8.8.10',
    './payment-ui.js?v=8.8.10',
    './favorites.js?v=8.8.10',
    
    './notifications.js?v=8.8.10',
    
    './stock-ui.js?v=8.8.10-stock-search',
    './gcash.js?v=8.8.10',
  
    './expenses.js?v=8.8.10',
    './status-ui.js?v=8.8.10',
    './pwa-lifecycle.js?v=8.8.10',
    './insights-base.js?v=8.8.10',
    './reporting-ui.js?v=8.8.10',
    './storage-db.js?v=8.8.10',
    './sync-engine.js?v=8.8.10',
    './app.js?v=8.8.10-stock-search',
    './item-sales.js?v=8.8.10',
    './ledger-ui.js?v=8.8.10-credit-collapse',
    './backup-actions.js?v=8.8.10-rest-delete',
    './business-actions.js?v=8.8.10',
  
    './business-ui.js?v=8.8.10',
    
    './ui-core.js?v=8.8.10',
    './product.js?v=8.8.10',
    './settings.js?v=8.8.10',
    './inventory-actions.js?v=8.8.10',
    './sales-export.js?v=8.8.10',
    './transaction-detail.js?v=8.8.10',
    './diagnostics.js?v=8.8.10-mobile-pill',
