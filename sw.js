...
const APP_SHELL = [
  OFFLINE_ENTRY,
  './manifest.webmanifest?v=8.8.6',
  './styles.css?v=8.8.6',
  './vendor/tailwind-forms-container.js?v=8.8.6',
  './vendor/fonts/fonts.css?v=8.8.6',
  './vendor/fonts/inter-latin.woff2',
  './vendor/fonts/material-symbols-outlined.woff2',
  './vendor/quagga.min.js?v=8.8.6',
  './vendor/firebase-app-compat.js?v=8.8.6',
  './vendor/firebase-auth-compat.js?v=8.8.6',
  './vendor/firebase-firestore-compat.js?v=8.8.6',
  './utils.js?v=8.8.6',
  './ledger.js?v=8.8.6',
  './receipts.js?v=8.8.6',
  
    './receipt-ui.js?v=8.8.6',
    './scanner.js?v=8.8.6',
    './camera-scanner.js?v=8.8.6',
  
    
    './cart.js?v=8.8.6',
    './payment-ui.js?v=8.8.6',
    './favorites.js?v=8.8.6',
    
    './notifications.js?v=8.8.6',
    
    './stock-ui.js?v=8.8.6',
    './gcash.js?v=8.8.6',
  
    './expenses.js?v=8.8.6',
    './status-ui.js?v=8.8.6',
    './pwa-lifecycle.js?v=8.8.6',
    './insights-base.js?v=8.8.6',
    './reporting-ui.js?v=8.8.6',
    './storage-db.js?v=8.8.6',
    './sync-engine.js?v=8.8.6',
    './app.js?v=8.8.6',
    './item-sales.js?v=8.8.6',
    './ledger-ui.js?v=8.8.6',
    './backup-actions.js?v=8.8.6',
    './business-actions.js?v=8.8.6',
  
    './business-ui.js?v=8.8.6',
    
    './ui-core.js?v=8.8.6',
    './product.js?v=8.8.6',
    './settings.js?v=8.8.6',
    './inventory-actions.js?v=8.8.6',
    './sales-export.js?v=8.8.6',
    './transaction-detail.js?v=8.8.6',
    './diagnostics.js?v=8.8.6',
