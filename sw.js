const CACHE_NAME = 'villacart-pos-v8.3.16';
...
const APP_SHELL = [
  './',
  './index.html',
  './manifest.webmanifest?v=8.3.16',
  './styles.css?v=8.3.16',
  './utils.js?v=8.3.16',
  './ledger.js?v=8.3.16',
  './receipts.js?v=8.3.16',
  
    './receipt-ui.js?v=8.3.16',
    './scanner.js?v=8.3.16',
    './camera-scanner.js?v=8.3.16',
  
    
    './cart.js?v=8.3.16',
    './payment-ui.js?v=8.3.16',
    './favorites.js?v=8.3.16',
    
    './notifications.js?v=8.3.16',
    
    './stock-ui.js?v=8.3.16',
    './gcash.js?v=8.3.16',
  
    './expenses.js?v=8.3.16',
    './status-ui.js?v=8.3.16',
    './pwa-lifecycle.js?v=8.3.16',
    './insights-base.js?v=8.3.16',
    './reporting-ui.js?v=8.3.16',
    './sync-engine.js?v=8.3.16',
    './app.js?v=8.3.16',
    './ledger-ui.js?v=8.3.16',
    './backup-actions.js?v=8.3.16',
    './business-actions.js?v=8.3.16',
  
    './business-ui.js?v=8.3.16',
    
    './ui-core.js?v=8.3.16',
    './product.js?v=8.3.16',
    './settings.js?v=8.3.16',
    './inventory-actions.js?v=8.3.16',
    './sales-export.js?v=8.3.16',
    './transaction-detail.js?v=8.3.16',
    './diagnostics.js?v=8.3.16',
