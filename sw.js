const CACHE_NAME = 'villacart-pos-v8.3.13';
...
const APP_SHELL = [
  './',
  './index.html',
  './manifest.webmanifest?v=8.3.13',
  './styles.css?v=8.3.13',
  './utils.js?v=8.3.13',
  './ledger.js?v=8.3.13',
  './receipts.js?v=8.3.13',
  
    './receipt-ui.js?v=8.3.13',
    './scanner.js?v=8.3.13',
    './camera-scanner.js?v=8.3.13',
  
    
    './cart.js?v=8.3.13',
    './payment-ui.js?v=8.3.13',
    './favorites.js?v=8.3.13',
    
    './notifications.js?v=8.3.13',
    
    './stock-ui.js?v=8.3.13',
    './gcash.js?v=8.3.13',
  
    './expenses.js?v=8.3.13',
    './status-ui.js?v=8.3.13',
    './pwa-lifecycle.js?v=8.3.13',
    './insights-base.js?v=8.3.13',
    './reporting-ui.js?v=8.3.13',
    './sync-engine.js?v=8.3.13',
    './app.js?v=8.3.13',
    './backup-actions.js?v=8.3.13',
    './business-actions.js?v=8.3.13',
  
    './business-ui.js?v=8.3.13',
    
    './ui-core.js?v=8.3.13',
    './product.js?v=8.3.13',
    './settings.js?v=8.3.13',
    './inventory-actions.js?v=8.3.13',
    './sales-export.js?v=8.3.13',
    './transaction-detail.js?v=8.3.13',
    './diagnostics.js?v=8.3.13',
