...
const APP_SHELL = [
  OFFLINE_ENTRY,
  './manifest.webmanifest?v=8.7.0',
  './styles.css?v=8.7.0',
  './vendor/tailwind-forms-container.js?v=8.7.0',
  './vendor/fonts/fonts.css?v=8.7.0',
  './vendor/fonts/inter-latin.woff2',
  './vendor/fonts/material-symbols-outlined.woff2',
  './vendor/quagga.min.js?v=8.7.0',
  './vendor/firebase-app-compat.js?v=8.7.0',
  './vendor/firebase-auth-compat.js?v=8.7.0',
  './vendor/firebase-firestore-compat.js?v=8.7.0',
  './utils.js?v=8.7.0',
  './ledger.js?v=8.7.0',
  './receipts.js?v=8.7.0',
  
    './receipt-ui.js?v=8.7.0',
    './scanner.js?v=8.7.0',
    './camera-scanner.js?v=8.7.0',
  
    
    './cart.js?v=8.7.0',
    './payment-ui.js?v=8.7.0',
    './favorites.js?v=8.7.0',
    
    './notifications.js?v=8.7.0',
    
    './stock-ui.js?v=8.7.0',
    './gcash.js?v=8.7.0',
  
    './expenses.js?v=8.7.0',
    './status-ui.js?v=8.7.0',
    './pwa-lifecycle.js?v=8.7.0',
    './insights-base.js?v=8.7.0',
    './reporting-ui.js?v=8.7.0',
    './storage-db.js?v=8.7.0',
    './sync-engine.js?v=8.7.0',
    './app.js?v=8.7.0',
    './item-sales.js?v=8.7.0',
    './ledger-ui.js?v=8.7.0',
    './backup-actions.js?v=8.7.0',
    './business-actions.js?v=8.7.0',
  
    './business-ui.js?v=8.7.0',
    
    './ui-core.js?v=8.7.0',
    './product.js?v=8.7.0',
    './settings.js?v=8.7.0',
    './inventory-actions.js?v=8.7.0',
    './sales-export.js?v=8.7.0',
    './transaction-detail.js?v=8.7.0',
    './diagnostics.js?v=8.7.0',
