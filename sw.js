...
const APP_SHELL = [
  OFFLINE_ENTRY,
  './manifest.webmanifest?v=8.7.1',
  './styles.css?v=8.7.1',
  './vendor/tailwind-forms-container.js?v=8.7.1',
  './vendor/fonts/fonts.css?v=8.7.1',
  './vendor/fonts/inter-latin.woff2',
  './vendor/fonts/material-symbols-outlined.woff2',
  './vendor/quagga.min.js?v=8.7.1',
  './vendor/firebase-app-compat.js?v=8.7.1',
  './vendor/firebase-auth-compat.js?v=8.7.1',
  './vendor/firebase-firestore-compat.js?v=8.7.1',
  './utils.js?v=8.7.1',
  './ledger.js?v=8.7.1',
  './receipts.js?v=8.7.1',
  
    './receipt-ui.js?v=8.7.1',
    './scanner.js?v=8.7.1',
    './camera-scanner.js?v=8.7.1',
  
    
    './cart.js?v=8.7.1',
    './payment-ui.js?v=8.7.1',
    './favorites.js?v=8.7.1',
    
    './notifications.js?v=8.7.1',
    
    './stock-ui.js?v=8.7.1',
    './gcash.js?v=8.7.1',
  
    './expenses.js?v=8.7.1',
    './status-ui.js?v=8.7.1',
    './pwa-lifecycle.js?v=8.7.1',
    './insights-base.js?v=8.7.1',
    './reporting-ui.js?v=8.7.1',
    './storage-db.js?v=8.7.1',
    './sync-engine.js?v=8.7.1',
    './app.js?v=8.7.1',
    './item-sales.js?v=8.7.1',
    './ledger-ui.js?v=8.7.1',
    './backup-actions.js?v=8.7.1',
    './business-actions.js?v=8.7.1',
  
    './business-ui.js?v=8.7.1',
    
    './ui-core.js?v=8.7.1',
    './product.js?v=8.7.1',
    './settings.js?v=8.7.1',
    './inventory-actions.js?v=8.7.1',
    './sales-export.js?v=8.7.1',
    './transaction-detail.js?v=8.7.1',
    './diagnostics.js?v=8.7.1',
