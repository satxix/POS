const CACHE_NAME = 'villacart-pos-v8.3.10';
...
const APP_SHELL = [
  './',
  './index.html',
  './manifest.webmanifest?v=8.3.10',
  './styles.css?v=8.3.10',
  './utils.js?v=8.3.10',
  './ledger.js?v=8.3.10',
  './receipts.js?v=8.3.10',
  
    './receipt-ui.js?v=8.3.10',
    './scanner.js?v=8.3.10',
    './camera-scanner.js?v=8.3.10',
  
    
    './cart.js?v=8.3.10',
    './payment-ui.js?v=8.3.10',
    './favorites.js?v=8.3.10',
    
    './notifications.js?v=8.3.10',
    
    './stock-ui.js?v=8.3.10',
    './gcash.js?v=8.3.10',
  
    './expenses.js?v=8.3.10',
    './status-ui.js?v=8.3.10',
    './pwa-lifecycle.js?v=8.3.10',
    './insights-base.js?v=8.3.10',
    './reporting-ui.js?v=8.3.10',
    './app.js?v=8.3.10',
    './backup-actions.js?v=8.3.10',
    './business-actions.js?v=8.3.10',
  
    './business-ui.js?v=8.3.10',
    
    './ui-core.js?v=8.3.10',
    './product.js?v=8.3.10',
    './settings.js?v=8.3.10',
    './inventory-actions.js?v=8.3.10',
    './sales-export.js?v=8.3.10',
    './transaction-detail.js?v=8.3.10',
    './diagnostics.js?v=8.3.10',
