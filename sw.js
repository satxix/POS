const CACHE_NAME = 'villacart-pos-v8.3.14';
...
const APP_SHELL = [
  './',
  './index.html',
  './manifest.webmanifest?v=8.3.14',
  './styles.css?v=8.3.14',
  './utils.js?v=8.3.14',
  './ledger.js?v=8.3.14',
  './receipts.js?v=8.3.14',
  
    './receipt-ui.js?v=8.3.14',
    './scanner.js?v=8.3.14',
    './camera-scanner.js?v=8.3.14',
  
    
    './cart.js?v=8.3.14',
    './payment-ui.js?v=8.3.14',
    './favorites.js?v=8.3.14',
    
    './notifications.js?v=8.3.14',
    
    './stock-ui.js?v=8.3.14',
    './gcash.js?v=8.3.14',
  
    './expenses.js?v=8.3.14',
    './status-ui.js?v=8.3.14',
    './pwa-lifecycle.js?v=8.3.14',
    './insights-base.js?v=8.3.14',
    './reporting-ui.js?v=8.3.14',
    './sync-engine.js?v=8.3.14',
    './app.js?v=8.3.14',
    './backup-actions.js?v=8.3.14',
    './business-actions.js?v=8.3.14',
  
    './business-ui.js?v=8.3.14',
    
    './ui-core.js?v=8.3.14',
    './product.js?v=8.3.14',
    './settings.js?v=8.3.14',
    './inventory-actions.js?v=8.3.14',
    './sales-export.js?v=8.3.14',
    './transaction-detail.js?v=8.3.14',
    './diagnostics.js?v=8.3.14',
