const CACHE_NAME = 'villacart-pos-v8.3.23';
...
const APP_SHELL = [
  './',
  './index.html',
  './manifest.webmanifest?v=8.3.23',
  './styles.css?v=8.3.23',
  './utils.js?v=8.3.23',
  './ledger.js?v=8.3.23',
  './receipts.js?v=8.3.23',
  
    './receipt-ui.js?v=8.3.23',
    './scanner.js?v=8.3.23',
    './camera-scanner.js?v=8.3.23',
  
    
    './cart.js?v=8.3.23',
    './payment-ui.js?v=8.3.23',
    './favorites.js?v=8.3.23',
    
    './notifications.js?v=8.3.23',
    
    './stock-ui.js?v=8.3.23',
    './gcash.js?v=8.3.23',
  
    './expenses.js?v=8.3.23',
    './status-ui.js?v=8.3.23',
    './pwa-lifecycle.js?v=8.3.23',
    './insights-base.js?v=8.3.23',
    './reporting-ui.js?v=8.3.23',
    './sync-engine.js?v=8.3.23',
    './app.js?v=8.3.23',
    './ledger-ui.js?v=8.3.23',
    './backup-actions.js?v=8.3.23',
    './business-actions.js?v=8.3.23',
  
    './business-ui.js?v=8.3.23',
    
    './ui-core.js?v=8.3.23',
    './product.js?v=8.3.23',
    './settings.js?v=8.3.23',
    './inventory-actions.js?v=8.3.23',
    './sales-export.js?v=8.3.23',
    './transaction-detail.js?v=8.3.23',
    './diagnostics.js?v=8.3.23',
