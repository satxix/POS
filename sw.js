const APP_VERSION = '8.4.9';
const CACHE_NAME = 'villacart-pos-v' + APP_VERSION;
const OFFLINE_ENTRY = './index.html?v=' + APP_VERSION;
const APP_SHELL = [
  OFFLINE_ENTRY,
  './manifest.webmanifest?v=8.4.9',
  './styles.css?v=8.4.9',
  './vendor/tailwind-forms-container.js?v=8.4.9',
  './vendor/fonts/fonts.css?v=8.4.9',
  './vendor/fonts/inter-latin.woff2',
  './vendor/fonts/material-symbols-outlined.woff2',
  './vendor/quagga.min.js?v=8.4.9',
  './vendor/firebase-app-compat.js?v=8.4.9',
  './vendor/firebase-auth-compat.js?v=8.4.9',
  './vendor/firebase-firestore-compat.js?v=8.4.9',
  './utils.js?v=8.4.9',
  './ledger.js?v=8.4.9',
  './receipts.js?v=8.4.9',
  
    './receipt-ui.js?v=8.4.9',
    './scanner.js?v=8.4.9',
    './camera-scanner.js?v=8.4.9',
  
    
    './cart.js?v=8.4.9',
    './payment-ui.js?v=8.4.9',
    './favorites.js?v=8.4.9',
    
    './notifications.js?v=8.4.9',
    
    './stock-ui.js?v=8.4.9',
    './gcash.js?v=8.4.9',
  
    './expenses.js?v=8.4.9',
    './status-ui.js?v=8.4.9',
    './pwa-lifecycle.js?v=8.4.9',
    './insights-base.js?v=8.4.9',
    './reporting-ui.js?v=8.4.9',
    './sync-engine.js?v=8.4.9',
    './app.js?v=8.4.9',
    './ledger-ui.js?v=8.4.9',
    './backup-actions.js?v=8.4.9',
    './business-actions.js?v=8.4.9',
  
    './business-ui.js?v=8.4.9',
    
    './ui-core.js?v=8.4.9',
    './product.js?v=8.4.9',
    './settings.js?v=8.4.9',
    './inventory-actions.js?v=8.4.9',
    './sales-export.js?v=8.4.9',
    './transaction-detail.js?v=8.4.9',
    './diagnostics.js?v=8.4.9',
