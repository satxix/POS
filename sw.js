const CACHE_NAME = 'villacart-pos-v8.3.25';
...
const APP_SHELL = [
  './',
  './index.html',
  './manifest.webmanifest?v=8.3.25',
  './styles.css?v=8.3.25',
  './utils.js?v=8.3.25',
  './ledger.js?v=8.3.25',
  './receipts.js?v=8.3.25',
  
    './receipt-ui.js?v=8.3.25',
    './scanner.js?v=8.3.25',
    './camera-scanner.js?v=8.3.25',
  
    
    './cart.js?v=8.3.25',
    './payment-ui.js?v=8.3.25',
    './favorites.js?v=8.3.25',
    
    './notifications.js?v=8.3.25',
    
    './stock-ui.js?v=8.3.25',
    './gcash.js?v=8.3.25',
  
    './expenses.js?v=8.3.25',
    './status-ui.js?v=8.3.25',
    './pwa-lifecycle.js?v=8.3.25',
    './insights-base.js?v=8.3.25',
    './reporting-ui.js?v=8.3.25',
    './sync-engine.js?v=8.3.25',
    './app.js?v=8.3.25',
    './ledger-ui.js?v=8.3.25',
    './backup-actions.js?v=8.3.25',
    './business-actions.js?v=8.3.25',
  
    './business-ui.js?v=8.3.25',
    
    './ui-core.js?v=8.3.25',
    './product.js?v=8.3.25',
    './settings.js?v=8.3.25',
    './inventory-actions.js?v=8.3.25',
    './sales-export.js?v=8.3.25',
    './transaction-detail.js?v=8.3.25',
    './diagnostics.js?v=8.3.25',
