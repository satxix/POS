...
const APP_SHELL = [
  OFFLINE_ENTRY,
  './manifest.webmanifest?v=8.7.3',
  './styles.css?v=8.7.3',
  './vendor/tailwind-forms-container.js?v=8.7.3',
  './vendor/fonts/fonts.css?v=8.7.3',
  './vendor/fonts/inter-latin.woff2',
  './vendor/fonts/material-symbols-outlined.woff2',
  './vendor/quagga.min.js?v=8.7.3',
  './vendor/firebase-app-compat.js?v=8.7.3',
  './vendor/firebase-auth-compat.js?v=8.7.3',
  './vendor/firebase-firestore-compat.js?v=8.7.3',
  './utils.js?v=8.7.3',
  './ledger.js?v=8.7.3',
  './receipts.js?v=8.7.3',
  
    './receipt-ui.js?v=8.7.3',
    './scanner.js?v=8.7.3',
    './camera-scanner.js?v=8.7.3',
  
    
    './cart.js?v=8.7.3',
    './payment-ui.js?v=8.7.3',
    './favorites.js?v=8.7.3',
    
    './notifications.js?v=8.7.3',
    
    './stock-ui.js?v=8.7.3',
    './gcash.js?v=8.7.3',
  
    './expenses.js?v=8.7.3',
    './status-ui.js?v=8.7.3',
    './pwa-lifecycle.js?v=8.7.3',
    './insights-base.js?v=8.7.3',
    './reporting-ui.js?v=8.7.3',
    './storage-db.js?v=8.7.3',
    './sync-engine.js?v=8.7.3',
    './app.js?v=8.7.3',
    './item-sales.js?v=8.7.3',
    './ledger-ui.js?v=8.7.3',
    './backup-actions.js?v=8.7.3',
    './business-actions.js?v=8.7.3',
  
    './business-ui.js?v=8.7.3',
    
    './ui-core.js?v=8.7.3',
    './product.js?v=8.7.3',
    './settings.js?v=8.7.3',
    './inventory-actions.js?v=8.7.3',
    './sales-export.js?v=8.7.3',
    './transaction-detail.js?v=8.7.3',
    './diagnostics.js?v=8.7.3',
