const CACHE_NAME = 'villacart-pos-v8.3.22';
...
const APP_SHELL = [
  './',
  './index.html',
  './manifest.webmanifest?v=8.3.22',
  './styles.css?v=8.3.22',
  './utils.js?v=8.3.22',
  './ledger.js?v=8.3.22',
  './receipts.js?v=8.3.22',
  
    './receipt-ui.js?v=8.3.22',
    './scanner.js?v=8.3.22',
    './camera-scanner.js?v=8.3.22',
  
    
    './cart.js?v=8.3.22',
    './payment-ui.js?v=8.3.22',
    './favorites.js?v=8.3.22',
    
    './notifications.js?v=8.3.22',
    
    './stock-ui.js?v=8.3.22',
    './gcash.js?v=8.3.22',
  
    './expenses.js?v=8.3.22',
    './status-ui.js?v=8.3.22',
    './pwa-lifecycle.js?v=8.3.22',
    './insights-base.js?v=8.3.22',
    './reporting-ui.js?v=8.3.22',
    './sync-engine.js?v=8.3.22',
    './app.js?v=8.3.22',
    './ledger-ui.js?v=8.3.22',
    './backup-actions.js?v=8.3.22',
    './business-actions.js?v=8.3.22',
  
    './business-ui.js?v=8.3.22',
    
    './ui-core.js?v=8.3.22',
    './product.js?v=8.3.22',
    './settings.js?v=8.3.22',
    './inventory-actions.js?v=8.3.22',
    './sales-export.js?v=8.3.22',
    './transaction-detail.js?v=8.3.22',
    './diagnostics.js?v=8.3.22',
