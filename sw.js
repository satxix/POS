const CACHE_NAME = 'villacart-pos-v8.3.9';
...
const APP_SHELL = [
  './',
  './index.html',
  './manifest.webmanifest?v=8.3.9',
  './styles.css?v=8.3.9',
  './utils.js?v=8.3.9',
  './ledger.js?v=8.3.9',
  './receipts.js?v=8.3.9',
  
    './receipt-ui.js?v=8.3.9',
    './scanner.js?v=8.3.9',
    './camera-scanner.js?v=8.3.9',
  
    
    './cart.js?v=8.3.9',
    './payment-ui.js?v=8.3.9',
    './favorites.js?v=8.3.9',
    
    './notifications.js?v=8.3.9',
    
    './stock-ui.js?v=8.3.9',
    './gcash.js?v=8.3.9',
  
    './expenses.js?v=8.3.9',
    './status-ui.js?v=8.3.9',
    './pwa-lifecycle.js?v=8.3.9',
    './insights-base.js?v=8.3.9',
    './reporting-ui.js?v=8.3.9',
    './app.js?v=8.3.9',
    './backup-actions.js?v=8.3.9',
    './business-actions.js?v=8.3.9',
  
    './business-ui.js?v=8.3.9',
    
    './ui-core.js?v=8.3.9',
    './product.js?v=8.3.9',
    './settings.js?v=8.3.9',
    './inventory-actions.js?v=8.3.9',
    './sales-export.js?v=8.3.9',
    './transaction-detail.js?v=8.3.9',
    './diagnostics.js?v=8.3.9',
