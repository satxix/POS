...
const APP_SHELL = [
  OFFLINE_ENTRY,
  './manifest.webmanifest?v=8.8.9',
  './styles.css?v=8.8.9-credit-collapse',
  './vendor/tailwind-forms-container.js?v=8.8.9',
  './vendor/fonts/fonts.css?v=8.8.9',
  './vendor/fonts/inter-latin.woff2',
  './vendor/fonts/material-symbols-outlined.woff2',
  './vendor/quagga.min.js?v=8.8.9',
  './vendor/firebase-app-compat.js?v=8.8.9',
  './vendor/firebase-auth-compat.js?v=8.8.9',
  './vendor/firebase-firestore-compat.js?v=8.8.9',
  './utils.js?v=8.8.9',
  './ledger.js?v=8.8.9',
  './receipts.js?v=8.8.9',
  
    './receipt-ui.js?v=8.8.9',
    './scanner.js?v=8.8.9',
    './camera-scanner.js?v=8.8.9',
  
    
    './cart.js?v=8.8.9',
    './payment-ui.js?v=8.8.9',
    './favorites.js?v=8.8.9',
    
    './notifications.js?v=8.8.9',
    
    './stock-ui.js?v=8.8.9',
    './gcash.js?v=8.8.9',
  
    './expenses.js?v=8.8.9',
    './status-ui.js?v=8.8.9',
    './pwa-lifecycle.js?v=8.8.9',
    './insights-base.js?v=8.8.9',
    './reporting-ui.js?v=8.8.9',
    './storage-db.js?v=8.8.9',
    './sync-engine.js?v=8.8.9',
    './app.js?v=8.8.9',
    './item-sales.js?v=8.8.9',
    './ledger-ui.js?v=8.8.9-credit-collapse',
    './backup-actions.js?v=8.8.9-rest-delete',
    './business-actions.js?v=8.8.9',
  
    './business-ui.js?v=8.8.9',
    
    './ui-core.js?v=8.8.9',
    './product.js?v=8.8.9',
    './settings.js?v=8.8.9',
    './inventory-actions.js?v=8.8.9',
    './sales-export.js?v=8.8.9',
    './transaction-detail.js?v=8.8.9',
    './diagnostics.js?v=8.8.9-mobile-pill',
