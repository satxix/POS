const APP_VERSION = '8.4.8';
const CACHE_NAME = 'villacart-pos-v' + APP_VERSION;
const OFFLINE_ENTRY = './index.html?v=' + APP_VERSION;
const APP_SHELL = [
  OFFLINE_ENTRY,
  './manifest.webmanifest?v=8.4.8',
  './styles.css?v=8.4.8',
  './vendor/tailwind-forms-container.js?v=8.4.8',
  './vendor/fonts/fonts.css?v=8.4.8',
  './vendor/fonts/inter-latin.woff2',
  './vendor/fonts/material-symbols-outlined.woff2',
  './vendor/quagga.min.js?v=8.4.8',
  './vendor/firebase-app-compat.js?v=8.4.8',
  './vendor/firebase-auth-compat.js?v=8.4.8',
  './vendor/firebase-firestore-compat.js?v=8.4.8',
  './utils.js?v=8.4.8',
  './ledger.js?v=8.4.8',
  './receipts.js?v=8.4.8',
  
    './receipt-ui.js?v=8.4.8',
    './scanner.js?v=8.4.8',
    './camera-scanner.js?v=8.4.8',
  
    
    './cart.js?v=8.4.8',
    './payment-ui.js?v=8.4.8',
    './favorites.js?v=8.4.8',
    
    './notifications.js?v=8.4.8',
    
    './stock-ui.js?v=8.4.8',
    './gcash.js?v=8.4.8',
  
    './expenses.js?v=8.4.8',
    './status-ui.js?v=8.4.8',
    './pwa-lifecycle.js?v=8.4.8',
    './insights-base.js?v=8.4.8',
    './reporting-ui.js?v=8.4.8',
    './sync-engine.js?v=8.4.8',
    './app.js?v=8.4.8',
    './ledger-ui.js?v=8.4.8',
    './backup-actions.js?v=8.4.8',
    './business-actions.js?v=8.4.8',
  
    './business-ui.js?v=8.4.8',
    
    './ui-core.js?v=8.4.8',
    './product.js?v=8.4.8',
    './settings.js?v=8.4.8',
    './inventory-actions.js?v=8.4.8',
    './sales-export.js?v=8.4.8',
    './transaction-detail.js?v=8.4.8',
    './diagnostics.js?v=8.4.8',
