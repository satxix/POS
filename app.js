// --- Firebase Configuration ---
    ...
    function setupRealTimeSync() {
        ...
        // v7.2.3: Inventory is local-first/manual-refresh.
...
(function(){
    ...
    // v7.2.3 cleanup: the v5.6.29 Ledger renderer is obsolete.
    // Its helper functions and CSS names remain for compatibility, but the
    // active renderer is the single v7.2.3 renderer below.
})();
...
(function(){
    ...
    async function vc5631Reconcile(reason, options = {}) {
        ...
        try {
            ...
            // v7.2.3: Do not auto-pull inventory here. Refresh Stock owns inventory reads.
            const localOldTransactions = (state.transactions || []).filter(t => t && typeof vc5632mInDateRange === 'function' && !vc5632mInDateRange(t, bounds));
            const localOldBusinessDays = (state.businessDays || []).filter(day => day && typeof vc5632mInDateRange === 'function' && !vc5632mInDateRange(day, bounds));
...
(function(){
    ...
    function vc5632RenderGroups(list, kind) {
        // v7.2.3: Credit must never use date grouping. This keeps phone,
...
// v7.2.3 Final Insights flicker guard: one owner for Business Day + Recent Activities.
(function(){
...
// v7.2.3 Insights Business Day card flicker guard.
...
// v7.2.3: Today-first auto sync + on-demand Month/Range cloud loads.
(function(){
...
// v7.2.3: Correct Cash Received and default Ledger to Today.
(function(){
...
// v7.2.3: Inventory cloud reconcile.
...
// v7.2.3: Ledger cleanup complete. Credit is rendered by the main v5.6.32 renderer.


// v7.2.3: Calendar-month backup/archive. Inventory is never archived/deleted.
(function(){
...
// v7.2.3: Business month arrows + favorite stock display.
