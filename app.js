// --- Firebase Configuration ---
    ...
    window.VILLACART_APP_VERSION = 'v8.0.39';
    ...
    // v8.0.39: The older fallback keydown listener was removed.
...
function switchScreen(id) {
    ...
    function renderInventoryCategory(catKey, group, searchValue) {
        ...
        // v8.0.39: Do not build every product row for collapsed categories.
    ...
    // v8.0.39: Standalone GCash service ledger.
...
(function(){
    ...
    // v8.0.39: Do not pre-render Stock while the PIN modal is still open.
