// --- Firebase Configuration ---
    ...
    window.VILLACART_APP_VERSION = 'v8.0.7';
    ...
    // v8.0.7: The older fallback keydown listener was removed.
...
function switchScreen(id) {
    ...
    function renderInventoryCategory(catKey, group, searchValue) {
        ...
        // v8.0.7: Do not build every product row for collapsed categories.
    ...
    // v8.0.7: Standalone GCash service ledger.
...
(function(){
    ...
    // v8.0.7: Do not pre-render Stock while the PIN modal is still open.
