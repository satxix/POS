// --- Firebase Configuration ---
    ...
    window.VILLACART_APP_VERSION = 'v8.3.17';
    ...
    // Transaction ID generation moved to payment-ui.js in v8.3.17.

    // Firestore/offline queue engine moved to sync-engine.js in v8.3.17.
...
function switchScreen(id) {
    ...
    // Sale commit moved to payment-ui.js in v8.3.17.
